<h2>Connect to Amazon Web Services</h2>
...
<input type="hidden" name="ext_id" value="{ServiceProvider_Aws::ID}">
...
<fieldset>
	...
	<input type="text" name="params[name]" value="{$params.name}" size="50" spellcheck="false"><br>
	<br>
